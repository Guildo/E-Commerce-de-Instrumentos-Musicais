...
<head>
	...
	<title>Dashboard Administrador - Ativar produtos</title>
							...
							for(EntidadeDominio ent : DadosProd){
								...
								if(prd.getId() == id){
									sb.append("<tr>");
										...
										sb.append("</td>");
									sb.append("</tr>");
									sb.append("<h4>Este produto esta desativado pois: </h4>");
									sb.append("<textarea id='motivo-desativacao' type='text' name='motivo-desativacao' ");
									sb.append("rows='1' class='form-control'>"+ prd.getMotivoDesativacao() + "</textarea>");
									sb.append("<form id='form' action='Produtos' method='POST'>");
										sb.append("<h3>Motivo de ativaçao: </h3>");
										sb.append("<input type='hidden' id='id-produto' name='idprd' value='"+id+"'/>");
										sb.append("<textarea id='motivo-ativacao' type='text' name='motivo-ativacao-produto' ");
										...
										sb.append("<button type='submit' id='Ativar"+prd.getId()+"' name='operacao' value='ATIVAR' title='Desativar' class='btn btn-success'>Ativar</button>");
									sb.append("</form>");
