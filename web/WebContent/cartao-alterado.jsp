...
<head>
	<meta charset="utf-8">
	<meta http-equiv="refresh" content="3;Cliente?operacao=CONSULTAR" />
	...
	<div class="section">
		...
		<div class="container" style="text-align: center">
			...
			<div style="text-align: center; margin-top:100px; padding-top:50px">
					...
					<h2>Seus dados de cartão foram alterados com sucesso!</h2>
...
<script type="text/javascript">
	function refresh(){
		...
		setTimeout(function a(){ 
			window.location.href = "Cartoes?idusr="+value+"&operacao=CONSULTAR";
	    }, 3000);
	}
	</script>
